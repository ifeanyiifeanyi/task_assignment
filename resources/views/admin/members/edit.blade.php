          ...
          <div class="card">
              <div class="card-body">
                  <form method="post" action="{{route('admin.member.update', $user)}}" enctype="multipart/form-data">
                      @csrf
                      <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Update
                          ...
                          <div class="col-md-4">
                              <div class="mb-3">
                                  <div class="form-check">
                                      <input type="checkbox" class="form-check-input" name="inter_dioceses"
                                             id="inter_dioceses" {{$user->inter_dioceses == 1 ? "checked" : ""}}>
                      ...
                      <div class="row mt-3">
                          <div class="col-md-5 mx-auto">
                              <div class="mb-3">
                                  <label for="role" class="form-label text-center">Change user access previleage <br>
                                      <span
                                          class="text-info">
                                            *(please
                                  ...
                                  <select class="form-control @error('role')  is-invalid @enderror" id="role"
                                          name="role">
                                      <option value="" selected disabled>Select user access previleage</option>
                                      @if($user->role == "admin")
