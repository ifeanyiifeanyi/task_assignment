...
<div class="sidebar-widget category-widget">
    ...
    <div class="widget-content">
        <ul class="category-list ">
            ...
            <li><a href="{{route('member.profile.view')}}"><i class="fa fa-credit-card" aria-hidden="true"></i>
                    Profile<span
            ...
            <li><a href="blog-details.html"><i class="fa fa-list-alt" aria-hidden="true"></i></i> Assignments </a></li>
