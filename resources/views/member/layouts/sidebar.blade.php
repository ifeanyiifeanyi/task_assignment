...
<div class="sidebar-widget category-widget">
    ...
    <div class="widget-content">
        <ul class="category-list ">
            ...
            <li class="current"> <a href="{{ route('member.dashboard') }}"><i class="fab fa fa-envelope "></i> Dashboard </a></li>
            ...
            <li><a href="{{ route('member.logout') }}"><i class="fa fa-chevron-circle-up" aria-hidden="true"></i> Logout </a></li>
        </ul>
    </div>
</div>